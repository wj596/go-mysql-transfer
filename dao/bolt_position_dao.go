...
type BoltPositionDao struct {
}

func (s *BoltPositionDao) Save(pipelineId uint64, pos mysql.Position) error {
...
func (s *BoltPositionDao) Get(pipelineId uint64) mysql.Position {
