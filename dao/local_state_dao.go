...
func (s *LocalStateDao) Save(pipelineId uint64, state *po.PipelineState) error {
...
func (s *LocalStateDao) IsExists(pipelineId uint64) (bool, error) {
	var exist bool
...
func (s *LocalStateDao) Get(pipelineId uint64) (*po.PipelineState, error) {
