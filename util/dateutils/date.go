...
const (
	DayFormatter                = "2006-01-02"              // 日期格式
	DayTimeMinuteFormatter      = "2006-01-02 15:04"        // 日期时间格式--分
	DayTimeSecondFormatter      = "2006-01-02 15:04:05"     // 日期时间格式--秒
	DayTimeMillisecondFormatter = "2006-01-02 15:04:05.sss" // 日期时间格式--毫秒
